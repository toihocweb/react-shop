...
module.exports = {
  ...
  add: async (values) => {
    ...
    return Detail.updateRelations({ _id: entry.id, values: relations });
  },
  ...
  edit: async (params, values) => {
    ...
    const entry = await Detail.updateOne(params, data, { multi: true });
  ...
  search: async (params) => {
    ...
    const $or = Object.keys(Detail.attributes).reduce((acc, curr) => {
      switch (Detail.attributes[curr].type) {
        case 'integer':
        case 'float':
        case 'decimal':
